...
import 'package:ceuk_user_app/user/dashboard/request/request_details_screen.dart';
...
class UserRequestHistory extends StatefulWidget {
  const UserRequestHistory({Key key}) : super(key: key);

  @override
  _ManageMessengersState createState() => _ManageMessengersState();
}

class _ManageMessengersState extends State<UserRequestHistory> {
  bool isLoaded = false;
    ...
    return GestureDetector(
      onTap: () {
        showMaterialModalBottomSheet(
          ...
          builder: (context) => UserRequestDetailsScreen(history: history),
        );
      },
      child: Container(
