...
class USersTransactionsPage extends StatefulWidget {
  const USersTransactionsPage({Key key}) : super(key: key);

  @override
  _ManageMessengersState createState() => _ManageMessengersState();
}

class _ManageMessengersState extends State<USersTransactionsPage> {
  bool isLoaded = false;
  ...
  Future<List> getBanks() async {
    ...
    UserTransactionsApi vendorsBankApi = UserTransactionsApi();
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        //   builder: (context) => UserRequestDetailsScreen(transaction: transaction),
        // );
      },
      child: Container(
