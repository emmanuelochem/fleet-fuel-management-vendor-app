...
class StaffForgotPasswordPage extends StatefulWidget {
  const StaffForgotPasswordPage({Key key}) : super(key: key);

  @override
  State<StaffForgotPasswordPage> createState() => _ForgotPasswordPageState();
}

class _ForgotPasswordPageState extends State<StaffForgotPasswordPage> {
